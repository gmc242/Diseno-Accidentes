...
{
    public class ConsultaFiltradaEdad : ConsultaFiltrada<int>
    {
        ...
        public override string ObtenerFiltros()
        {
            ...
            if (YaEnConsulta())
            {
                ...
                int indexSF = consulta.ObtenerFiltros().IndexOf("p.Edad");
                ...
                string filtros = consulta.ObtenerFiltros().Substring(0, indexSF) + " (p.Edad = " + edad_str + " OR " +
            ...
            {
                return consulta.ObtenerFiltros() + " " + ObtenerEnlace() + " p.Edad = " + edad_str ;
            }
        }
        ...
        {
            return consulta.ObtenerFiltros().Contains("p.Edad");
        }
    }
}